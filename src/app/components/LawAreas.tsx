...
export default function LawAreas() {
  return (
    <section style={{ padding:"16px  0 80px 0", background:"#fff" }}>
      <div className="container">
        ...
        <h2 style={{ textAlign:"center", fontSize:"clamp(26px,4vw,38px)", fontWeight:800, marginBottom:12 }}>
          Covers Every Area of <span style={{ color:"#1a5caa" }}>Sri Lankan Law</span>
        </h2>
        <p style={{ textAlign:"center", color:"#64748b", fontSize:16, maxWidth:560, margin:"0 auto 48px" }}>
